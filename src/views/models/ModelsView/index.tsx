...
export function ModelsView() {
	...
	const editModel = useStable((_name: string) => {
	...
	return (
		<Group h="100%" wrap="nowrap" gap="var(--surrealist-divider-size)">
			...
			{details ? (
				...
				>
					<Text>
						Upload your SurrealML models directly to SurrealDB and use the power
						of Machine Learning within your queries.
					</Text>
					{!isAvailable && (
						<Group gap="sm" c="pink">
					...
					<Group>
						...
						<Button
							...
							onClick={() =>
								adapter.openUrl("https://surrealdb.com/docs/surrealml")
							}
						>
							Learn more
						</Button>
