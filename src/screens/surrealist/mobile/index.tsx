 ...
 * navigation, account, AI integrations or Newsfeed — via tap or drag.
 */
export function MobileNavigation() {
	...
	useIntent("open-ai-integrations", () => card.setPanel("ai"));
