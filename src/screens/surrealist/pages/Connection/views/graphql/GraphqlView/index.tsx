...
import { checkGraphqlSupport } from "~/screens/surrealist/pages/Connection/connection/connection";
	...
	return isAvailable ? (
		...
		>
			...
			<Button
				...
				onClick={() =>
					adapter.openUrl("https://surrealdb.com/docs/learn/querying/graphql/overview")
				}
			>
				Learn more
			</Button>
