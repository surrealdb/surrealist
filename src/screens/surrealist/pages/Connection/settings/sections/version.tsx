			...
			{variant === "drawer" && (
				<Box mb="xl">
					...
					<Text
						...
						fz="lg"
					>
						Update your instance to a newer version of SurrealDB to access the latest
						features and improvements. Select an available version from the list to
						update to.
					</Text>
				</Box>
			)}
