...
export function NewEmbedPage() {
	...
	return (
		<>
			<PageBreadcrumbs
				items={[{ label: "Surrealist", href: "/" }, { label: "Embed Surrealist" }]}
			/>
			<Box
				flex={1}
				pos="relative"
							...
							<Grid.Col span={7}>
								<Stack gap="xl">
									...
									<Paper p="xl">
										...
										<Text>
											Copy your Surrealist Mini as an embeddable iframe
											snippet or as direct URL
										</Text>
										<SimpleGrid
											cols={2}
											mt="xl"
