...
export function ClusterStorageSection({ details, setDetails }: DeploySectionProps) {
	...
	return (
		<>
			<Box mt="xl">
				<PrimaryTitle fz={22}>Storage class</PrimaryTitle>
			...
			<Box mt="xl">
				<PrimaryTitle fz={22}>Storage size</PrimaryTitle>
				{/* <Text fz="lg">Set a desired initial size for your storage volume</Text> */}
