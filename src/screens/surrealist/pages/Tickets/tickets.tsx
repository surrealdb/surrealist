                ...
                >
                    ...
                    >
                        <Stack gap={2.5}>
                            ...
                            <Text fz="lg">
                                Showing all tickets for {org?.name}.
                            </Text>
                        </Stack>
                    </Group>
                        ...
                        <Table>
                            ...
                            <Table.Tbody>
                                {(!pageSlice || pageSlice?.length === 0) && (
                                    <Table.Tr>
                                        <Table.Td colSpan={5}>
                                            <Text ta="center" mt="xl" fz="lg">No tickets found</Text>
                                        </Table.Td>
                                    </Table.Tr>
                                )}
                                    ...
                                    >
                                        ...
                                        <Table.Td>
                                            <Stack>
                                                ...
                                                <Text>{dayjs(ticket.created_at).format("MMMM D, YYYY - HH:mm A")}</Text>
                                            </Stack>
                                        </Table.Td>
                                        <Table.Td>{ticket.type.name}</Table.Td>
                                        <Table.Td>{ticket.contacts.map((contact) => contact.name).join(", ")}</Table.Td>
                                        <Table.Td>
                                            <Badge
                                                variant="light"
