...
export function openNewTicketModal(organization: string) {
	openModal({
		...
		children: <NewTicketModal organization={organization} />,
	});
}
...
function NewTicketModal({ organization }: NewTicketModalProps) {
	...
	const { data: ticketTypes, isPending: ticketTypesPending } =
		useCloudTicketTypesQuery(organization);
