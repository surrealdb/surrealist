...
export function LegacyModal() {
	...
	return (
		...
		>
			...
			<Stack>
				<Text c="bright">Welcome back to Surrealist!</Text>

				<Text c="bright">
					Your configuration has been automatically migrated to the new format
					so you can continue where you left off.
				</Text>

				<Text>
					Want to learn more about the new Surrealist? Feel free to visit the{" "}
					<Anchor href="https://github.com/surrealdb/Surrealist/releases/tag/v2.0.0">
						changelog
					</Anchor>{" "}
					or read our updated{" "}
					<Anchor href="https://surrealdb.com/docs/surrealist">
						documentation
					</Anchor>
					.
				</Text>
